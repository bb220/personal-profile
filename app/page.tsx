  ...
  return (
    <main className="main">
      ...
      <p className="lead dropcap">
        Hello. I'm a product manager and software engineer. I'm interested in finding new and improved ways of doing things and building businesses around them. I'm currently building AI products. This site hosts my blog posts and projects. Say hello on{" "}
